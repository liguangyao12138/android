...
public class SdBasicOperationActivity extends AppCompatActivity {

    private TextView tv_sdBasicOperation;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sd_basic_operation);
    ...
    private void getEnvironmentInfo() {
        tv_sdBasicOperation = findViewById(R.id.tv_sdBasicOperation);
        ...
        tv_sdBasicOperation.setText(desc);
